...
export function MedalIcon({ rank, className = "w-4 h-4" }: { rank: number; className?: string }) {
  if (rank === 1) {
    return (
      <svg className={`${className} text-[#F2B705]`} viewBox="0 0 24 24" fill="currentColor">
  ...
  if (rank === 2) {
    return (
      <svg className={`${className} text-[#CBD5E1]`} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2l2.4 4.8 5.3.8-3.8 3.7.9 5.3L12 14.1l-4.8 2.5.9-5.3L4.3 7.6l5.3-.8L12 2z" />
      </svg>
    );
  }
  return (
    <svg className={`${className} text-[#E57C23]`} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 2l2.4 4.8 5.3.8-3.8 3.7.9 5.3L12 14.1l-4.8 2.5.9-5.3L4.3 7.6l5.3-.8L12 2z" />
    </svg>
  );
}
...
export function RotateCwIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function LayoutGridIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
