            ...
            <div className="min-w-[960px] mx-auto">
              ...
              <div className="grid grid-cols-4 gap-8 items-center relative min-h-[480px]">
                ...
                <div className="flex flex-col justify-center h-full z-10">
                  <MatchCard match={gfMatch} onViewBoxScore={() => setActiveBoxScore(gfMatch)} />
                </div>
...
function MatchCard({ match, onViewBoxScore }: { match: BracketMatch; onViewBoxScore: () => void }) {
  return (
    <div className="w-52 sm:w-56 rounded-lg border border-panel-border bg-card-bg overflow-hidden shadow-xl flex flex-col">
      <div className="flex items-center justify-between px-3.5 py-2 font-sans text-xs font-bold text-foreground bg-raised-panel border-b border-panel-border">
      ...
      <div className="flex items-center justify-between px-3.5 py-2 font-sans text-xs font-bold text-foreground bg-card-bg">
