      ...
      <div className="w-full max-w-md bg-card-bg border border-raised-panel rounded-2xl p-6 sm:p-8 shadow-2xl">
        ...
        <div className="mb-6">
          <button
            ...
            className="w-full h-11 rounded-lg bg-white text-gray-900 hover:bg-gray-100 font-sans text-xs font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-3 cursor-pointer shadow-md"
          >
            {isGoogleLoading ? (
