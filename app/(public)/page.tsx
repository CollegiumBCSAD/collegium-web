      ...
      <section className="mx-auto max-w-[1800px] w-full px-4 sm:px-6 md:px-10 lg:px-16 py-10 sm:py-16 lg:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-16 items-start">
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            <span className="font-sans text-xs font-normal tracking-widest text-secondary-brand uppercase mb-4 sm:mb-6 flex items-center gap-2">
            ...
            <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row w-full sm:w-auto gap-3 sm:gap-4">
              ...
              <Link
                href="/register"
                className="inline-flex h-12 items-center justify-center rounded border border-raised-panel bg-transparent px-6 text-sm font-normal text-foreground transition-colors hover:bg-raised-panel w-full sm:w-auto text-center"
              >
                Register Your Team
              </Link>
            </div>
          ...
          <div className="lg:col-span-5 w-full mt-2 lg:mt-24">
            <div className="rounded-lg border border-raised-panel bg-card-bg/15 p-4 sm:p-6 shadow-xl backdrop-blur-xs">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 sm:gap-3 text-xs font-normal uppercase tracking-wider mb-4 sm:mb-6">
                <span className="text-secondary-text truncate">UAAP–NCAA INVITATIONAL · VALORANT</span>
        ...
        <div className="mx-auto max-w-[1800px] w-full px-4 sm:px-6 md:px-10 lg:px-16">
          ...
          <div className="grid grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {featuredGames.map((game) => (
              <div
                key={game.title}
                className="relative flex flex-col justify-between rounded-xl border border-raised-panel bg-card-bg p-4 transition-all hover:border-raised-panel/80"
              >
                <div>
                  <img
                    src={game.image}
